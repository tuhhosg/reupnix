{ description = (
    ...
    new-nixpkgs = { url = "github:NixOS/nixpkgs/9370544d849be8a07193e7611d02e6f6f1b10768"; };
...
in rec {
    ...
    in lib.wip.importRepo age-inputs ./. (repo: { "${age}-systemsFlake"  = lib.wip.mkSystemsFlake {
        inputs = age-inputs // { self = self // repo; };
